/*
  ...
  - Made the column `fanbase` on table `Product` required. This step will fail if there are existing NULL values in that column.
...
ALTER COLUMN "fanbase" SET NOT NULL;
